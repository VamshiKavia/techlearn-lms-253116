    ...
    <div style={{ display: 'grid', placeItems: 'center', minHeight: '100vh', background: 'var(--bg-subtle)' }}>
      <div className="card" style={{ width: 'min(520px, 94vw)', padding: 20, borderRadius: 12 }}>
        ...
        <div style={{ marginTop: 16, fontSize: 12, color: 'var(--text-muted)' }}>
          Admin note: Configure Auth URL settings in Supabase Dashboard → Auth → URL Configuration. Set the Site URL
          for your environment. Redirects for email confirmation should include your deployed and development URLs.
        </div>

        <div style={{ marginTop: 12, fontSize: 12 }}>
          <Link to="/login">Go to simple sign-in page</Link>
        </div>
      </div>
    </div>
  );
